...
#4) $ Import-Module .\Get-FileEncoding.ps1


# Now you can navigate anywhere and find out file encodings
# For example


# $ Get-ChildItem *.* | select FullName, @{n='Encoding';e={Get-FileEncoding $_.FullName}}


# will list all files and found encoding information on file
# $ Get-ChildItem *.* | select FullName, @{n='Encoding';e={Get-FileEncoding $_.FullName}} | where {$_.Encoding -ne 'UTF8'}
