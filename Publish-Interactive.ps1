...
if($transformName.Length -gt 1){
    $publishProjTemp = Get-ChildItem $deployFolder -Name "*pw.TransformConfig.proj" -Recurse
...
#https://github.com/sayedihashimi/package-web/blob/master/Publish-Interactive.ps1
