...
:: Servers to be un-shunted are All IVR Web Application servers

SET WebAppServers=ALL_IVR_WEBS.txt

:: Choice Dialog

choice /t:n,10 Are you sure you want to un-shunt All IVR Nodes
...
echo All IVR Nodes Un-Shunt completed >> \\%StartDir%\message.txt
