...
:: Servers to be shunted are DS Backup IVR Web Application servers only

SET WebAppServers=DS_IVR_WEBS.txt

:: Choice Dialog

choice /t:n,10 Are you sure you want to shunt DS Backup IVR Node 
...
echo DS Backup IVR Node Shunt completed >> \\%StartDir%\message.txt
