...
:: Servers to be shunted are AU Primary IVR Web Application servers only

SET WebAppServers=AU_IVR_WEBS.txt

:: Choice Dialog

choice /t:n,10 Are you sure you want to shunt AU Primary IVR Node 
...
echo AU Primary IVR Node Shunt completed >> \\%StartDir%\message.txt
