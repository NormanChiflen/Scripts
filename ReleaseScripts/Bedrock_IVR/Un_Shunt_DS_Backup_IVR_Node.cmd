...
:: Servers to be un-shunted are DS Backup IVR Web Application servers only

SET WebAppServers=DS_IVR_WEBS.txt

:: Choice Dialog

choice /t:n,10 Are you sure you want to un-shunt DS Backup IVR Node
...
echo DS Backup IVR Node Un-Shunt completed >> \\%StartDir%\message.txt
