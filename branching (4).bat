...
if exist %targetphysicalpath%\%targetname%\build.cmd (
  ...
  echo p4 edit %targetphysicalpath%\%targetname%\build.cmd
  p4 edit %targetphysicalpath%\%targetname%\build.cmd
 echo notepad %targetphysicalpath%\%targetname%\build.cmd
  rem rm -rf %targetphysicalpath%\%targetname%\build.cmd
   rem move %targetphysicalpath%\%targetname%\build.cmd %targetphysicalpath%\%targetname%\build_%date:~0,2%_%date:~3,2%_%time:~3,2%.bak
   move %targetphysicalpath%\%targetname%\build.cmd %targetphysicalpath%\%targetname%\build.cmd.bak
   xcopy \\karmalab.net\builds\buildtools\REMTools\P4Branch\build.cmdP %targetphysicalpath%\%targetname%\ /E /C /I /Q /G /H /R /K /Y /Z  
   echo renaming %targetphysicalpath%\%targetname%\build.cmdP
   move %targetphysicalpath%\%targetname%\build.cmdP %targetphysicalpath%\%targetname%\build.cmd
   rem p4 add -c %changelist% %targetphysicalpath%\%targetname%\build.cmd
   echo Running "p4 submit %targetphysicalpath%\%targetname%\build.cmd"
   p4 submit -d "resolving p vs. v branch conflict" %targetphysicalpath%\%targetname%\build.cmd
) else (
...
echo notepad %targetphysicalpath%\%targetname%\build.cmd
  ...
  rem rm -rf %targetphysicalpath%\%targetname%\build.cmd
   rem move %targetphysicalpath%\%targetname%\build.cmd %targetphysicalpath%\%targetname%\build_%date:~0,2%_%date:~3,2%_%time:~3,2%.bak
   move %targetphysicalpath%\%targetname%\build.cmd %targetphysicalpath%\%targetname%\build.cmd.bak
   xcopy \\karmalab.net\builds\buildtools\REMTools\P4Branch\build.cmdV %targetphysicalpath%\%targetname%\ /E /C /I /Q /G /H /R /K /Y /Z
   echo renaming %targetphysicalpath%\%targetname%\build.cmdV
   move %targetphysicalpath%\%targetname%\build.cmdV %targetphysicalpath%\%targetname%\build.cmd
   rem p4 add -c %changelist% %targetphysicalpath%\%targetname%\build.cmd
   echo Running "p4 submit %targetphysicalpath%\%targetname%\build.cmd"
   p4 submit -d "resolving p vs. v branch conflict" %targetphysicalpath%\%targetname%\build.cmd
) else (
